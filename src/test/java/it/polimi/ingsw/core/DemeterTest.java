...
public class DemeterTest {
	...
	public void checkBuildTestCorner() throws NoBuildException {
		...
		assertEquals(4, demeter.checkBuild(map, player.getWorker1(), turn).size());

		i=0; j=1;
		Build newBuild = new Build(player.getWorker1(), map.getCell(i, j), false, TypeBuild.SIMPLE_BUILD);
		assertTrue(demeter.checkBuild(map, player.getWorker1(), turn).contains(newBuild));

		i=1; j=0;
		Build newBuild1 = new Build(player.getWorker1(), map.getCell(i, j), false, TypeBuild.SIMPLE_BUILD);
		assertTrue(demeter.checkBuild(map, player.getWorker1(), turn).contains(newBuild1));
		...
		assertTrue(demeter.checkBuild(map, player.getWorker1(), turn).contains(newBuild2));
		...
		assertTrue(demeter.checkBuild(map, player.getWorker1(), turn).contains(newBuild3));

		i=0; j=1;
		Build newBuild4 = new Build(player.getWorker1(), map.getCell(i, j), true, TypeBuild.SIMPLE_BUILD);
		assertFalse(demeter.checkBuild(map, player.getWorker1(), turn).contains(newBuild4)); //assertFalse because it could not be built a dome there
	...
	public void checkBuildTestGeneral() throws NoBuildException {
		...
		assertEquals(9, demeter.checkBuild(map, player.getWorker1(), turn).size());
		...
		assertTrue(demeter.checkBuild(map, player.getWorker1(), turn).contains(newBuild4));
		...
		assertTrue(demeter.checkBuild(map, player.getWorker1(), turn).contains(newBuild5));
		...
		assertTrue(demeter.checkBuild(map, player.getWorker1(), turn).contains(newBuild6));
		...
		assertTrue(demeter.checkBuild(map, player.getWorker1(), turn).contains(newBuild7));
		...
		assertTrue(demeter.checkBuild(map, player.getWorker1(), turn).contains(newBuild8));
