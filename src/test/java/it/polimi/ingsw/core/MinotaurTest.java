...
public class MinotaurTest {
	...
	public void checkMoveTestGeneral() throws NoMoveException {
		...
		assertEquals(5, minotaur.checkMove(map, player.getWorker1(), turn).size());

		i=0; j=0;
		Move newMove = new Move(TypeMove.SIMPLE_MOVE, map.getCell(x, y), map.getCell(i, j), player.getWorker1());
		assertTrue(minotaur.checkMove(map, player.getWorker1(), turn).contains(newMove));

		i=1; j=0;
		Move newMove1 = new Move(TypeMove.SIMPLE_MOVE, map.getCell(x,y), map.getCell(i,j), player.getWorker1());
		assertTrue(minotaur.checkMove(map, player.getWorker1(), turn).contains(newMove1));

		i=0; j=2;
		Move newMove2 = new Move(TypeMove.SIMPLE_MOVE, map.getCell(x,y), map.getCell(i,j), player.getWorker1());
		assertTrue(minotaur.checkMove(map, player.getWorker1(), turn).contains(newMove2));
		...
		assertTrue(minotaur.checkMove(map, player.getWorker1(), turn).contains(newMove3));
		...
		assertTrue(minotaur.checkMove(map, player.getWorker1(), turn).contains(newMove4));
	 ...
	 */
	@Test
	public void checkMoveTestOneOpponentWorkerInCorner() throws NoMoveException {
		x=1; y=1; x1=2; y1=2;
		h=0; k=0; h1=1; k1=2;
		map.getCell(x, y).setWorker(player.getWorker1());
		player.getWorker1().setPos(map.getCell(x, y));
		...
		assertEquals(3, minotaur.checkMove(map, player.getWorker1(), turn).size());
	 ...
	 */
	@Test
	public void checkMoveTestOneOpponentWorkerInCorner2() throws NoMoveException {
		x=1; y=1; x1=2; y1=2;
		h=0; k=0; h1=1; k1=2;
		map.getCell(x, y).setWorker(player.getWorker1());
		player.getWorker1().setPos(map.getCell(x, y));
